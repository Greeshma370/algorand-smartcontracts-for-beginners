...
class _GlobalState:
    ...
    def last_changed_by(self) -> str:
        """Get the current value of the last_changed_by key in global_state state"""
        value = self.app_client.state.global_state.get_value("last_changed_by")
...
class CounterClient:
    ...
    def decode_return_value(
        self,
        method: typing.Literal["get()uint64"],
        return_value: algokit_utils.ABIReturn | None
    ) -> int | None: ...
    @typing.overload
    def decode_return_value(
...
class CounterFactoryCreateParams:
    ...
    def get_address(
        ...
        *,
        ...
        """Creates a new instance using the get_address()address ABI method"""
        params = params or algokit_utils.CommonAppCallCreateParams()
    ...
    def get(
        ...
        *,
        ...
        """Creates a new instance using the get()uint64 ABI method"""
        params = params or algokit_utils.CommonAppCallCreateParams()
        return self.app_factory.params.create(
            algokit_utils.AppFactoryCreateMethodCallParams(
                **{
    ...
    def decrement(
        ...
        *,
        ...
        """Creates a new instance using the decrement()void ABI method"""
        params = params or algokit_utils.CommonAppCallCreateParams()
        return self.app_factory.params.create(
            algokit_utils.AppFactoryCreateMethodCallParams(
                **{
